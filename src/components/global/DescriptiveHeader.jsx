...
export default function DescriptiveHeader({ title, description }) {
  ...
  return (
    <div className="w-full flex flex-col justify-between items-center bg-light rounded-md shadow-lg p-2 mb-4">
      <div className="flex w-full justify-between items-center h-10">
        ...
        <InfoIcon
          ...
          onClick={() => setFilterHeight(filterHeight === 'auto' ? 0 : 'auto')}
        />
      </div>
